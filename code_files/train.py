...
# Training the model
def train_and_save(model, optimizer, x_train, x_plot, u_analytical, epochs=n_epochs, plot_interval=200):
    for epoch in range(epochs):
        ...
        physics_loss_val = Physics_Informed_Loss.physics_loss(model, x_train)
